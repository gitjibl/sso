...
/**
 * 如果我们认证的方式仅仅是传统的用户名和密码，
 * 实现AbstractUsernamePasswordAuthenticationHandler这个抽象类就可以了
 */
public class CustomUsernamePasswordAuthentication extends AbstractUsernamePasswordAuthenticationHandler {
    ...
    @Override
    protected AuthenticationHandlerExecutionResult authenticateUsernamePasswordInternal(UsernamePasswordCredential usernamePasswordCredential, String originalPassword) throws GeneralSecurityException, PreventedException {
